...
class ModelTrainer:
    ...
    def fit_with_ann(self, item, fitness_type=None):
        ...
        ann_predictor.fit(x_train, y_train, validation_split=0.2, batch_size=batch_size, epochs=Config.EPOCHS)
    ...
    def fit_with_lstm(self, item):
        ...
        err = lstm_predictor.evaluate(x_test, y_test, data_normalizer)
        print(err)
