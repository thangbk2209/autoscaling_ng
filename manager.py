...
def evaluate_model():
    ...
    if model_name == 'ann':
        model_evaluator.evaluate_ann(iteration, preprocess_item)
    elif model_name == 'lstm':
        model_evaluator.evaluate_lstm(iteration, preprocess_item)
    elif model_name == 'bnn':
        model_evaluator.evaluate_bnn(iteration, preprocess_item)
    else:
